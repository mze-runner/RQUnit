...
from ..violations import build_report, exit_code, render_text, resolve_format
...
def main(store_path: Path | None, artifacts: tuple[Path, ...], fmt: str | None, strict: bool) -> None:
